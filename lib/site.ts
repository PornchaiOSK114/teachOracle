...
export type Product = {
  ...
  /**
   * บอกลูกค้าตรง ๆ ก่อนจ่ายเงินว่าไฟล์จะมีอีเมลเขากำกับไว้
   *
   * ไม่ใช่แค่เรื่องความตรงไปตรงมา แต่เป็นตัวป้องปรามที่ได้ผลกว่าตัวลายน้ำเองด้วย
   * เพราะคนที่คิดจะเอาไปแจกต่อจะรู้ตั้งแต่ก่อนซื้อว่าไฟล์สาวกลับมาถึงเขาได้
   * ไม่มีค่า = ไม่แสดงแถวนี้
   */
  fileNote?: string;
...
export const products: readonly Product[] = [
  {
    ...
    fileNote:
      'ไฟล์ PDF ที่คุณได้รับจะมีอีเมลที่ใช้ตอนสั่งซื้อกำกับไว้ทุกหน้า ยกเว้นหน้าปก และดาวน์โหลดได้ 5 ครั้ง ส่วนสคริปต์แล็บโหลดได้ไม่จำกัด',
